...
Usando a função mahalonobis, como métrica de distância, foram encotrados os 0.01% casos mais distantes, mostrados a seguir, que podem ser tratados como outliers, porém a extração delas não afetou o modelo, por fim foi decidido mantelas.
```{r}
